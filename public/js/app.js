...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecordsRouter = __webpack_require__(272);
		...
		view: function(map) {
			...
			collection.fetch({
				success: function(self, response) {
					...
					React.render(React.createElement(View, {collection: self}), document.getElementById('app'));
				}
			});
		}
	});
			...
			return (
				React.createElement("div", {className: "row"}, 
					React.createElement("div", {className: "col-md-12"}, 
						React.createElement("div", {className: "panel panel-white"}, 
							React.createElement("div", {className: "panel-heading clearfix"}, 
								React.createElement("h4", {className: "panel-title"}, "Pro Records")
							), 
							React.createElement("div", {className: "panel-body"}, 
								React.createElement("div", {className: "table-responsive"}, 
									React.createElement("table", {className: "table"}, 
										...
										React.createElement("tbody", null, 
											 records.pro.map(function(entry) { return (
												React.createElement(RecordListItem, {key: entry.id, data: entry})
											); }, this)										
										)
									)
